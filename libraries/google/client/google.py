from libraries.google.authentication.load_authentication import GoogleAuthenticationHandler
...
class Google:
    ...
    def quarantine_email(self, message_id: str, affected_user: str) -> bool:
        """
    ...
    def bulk_quarantine_email(self, message_id: str, affected_user: str) -> bool:
        """
        Moves a specific email to a quarantine label/folder for the user.
